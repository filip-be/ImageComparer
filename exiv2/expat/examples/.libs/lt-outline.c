...
/* examples/.libs/lt-outline.c - temporary wrapper executable for .libs/outline
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1

   The examples/outline program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/c/gnu.master/expat-2.1.0/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/c/gnu.master/expat-2.1.0/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "outline"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/outline - temporary wrapper script for .libs/outline\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/outline program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libexpat.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"outline:examples/outline:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"outline:examples/outline:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"outline:examples/outline:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/c/gnu.master/expat-2.1.0/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/gnu.master/expat-2.1.0/.libs:$PATH\"\n", f);
  fputs ("\n", f);

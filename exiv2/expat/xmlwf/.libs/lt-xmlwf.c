...
/* xmlwf/.libs/lt-xmlwf.c - temporary wrapper executable for .libs/xmlwf
...
const char * TARGET_PROGRAM_NAME = "xmlwf"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# xmlwf/xmlwf - temporary wrapper script for .libs/xmlwf\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The xmlwf/xmlwf program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"xmlwf:xmlwf/xmlwf:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"xmlwf:xmlwf/xmlwf:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"xmlwf:xmlwf/xmlwf:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
